...
server.patch('/api/v1.0/reminders/:id', (req, res, next) => {
    ...
    usersWithReminders[user][req.params.id] = reminder = Object.assign({}, reminder, pick(req.body, 'id', 'active', 'description', 'nextNotification', 'lastNotificationSent', 'notificationPlan'));
