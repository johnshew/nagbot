...
function Nag() {
    var done = true;
    reminders_1.RemindersDB.forEach((reminder) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (notify) {
            ...
            let operationStatus = yield reminders_1.RemindersDB.update(reminder);
            if (operationStatus.result.ok !== 1)
                throw new Error('Problem updating reminder');
        }
    }));
    return done;
}
