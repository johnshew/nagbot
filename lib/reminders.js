...
class ReminderDB {
    constructor() {
        this.client = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            new MongoClient().connect(`mongodb://shew-mongo:${encodeURIComponent(mongoPassword)}@shew-mongo.documents.azure.com:10255/?ssl=true&replicaSet=globaldb`, (err, client) => {
                if (err) {
